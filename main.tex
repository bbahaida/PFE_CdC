...
A ce niveau, nous devons spécifier nos exigences en langage naturel, en utilisant les fiche GABARIT-VOLERE\cite{volere}.
\\
\\
\noindent\fbox{%
    \parbox{\textwidth}{%
...
\noindent\fbox{%
    \parbox{\textwidth}{%
        ...
        \\
        \\
        \textbf{Cas d’utilisation:} Consulter l'état d'exécution d'un job
        \\
        \\
...
\noindent\fbox{%
    \parbox{\textwidth}{%
        \textbf{Numero d'exigence:} EF13
        \qquad \textbf{Type d'exigence:} Exigence fonctionnelle
         \\
        \\
        \textbf{Cas d’utilisation:} Choisir un algorithme
        \\
        \\
        \textbf{Description :} le système doit permettre au Manager de choisir un algorithme pour l'appliquer.
        \\
        \\
        \textbf{Acteur:} Manager
        \\
...
\noindent\fbox{%
    \parbox{\textwidth}{%
        \textbf{Numero d'exigence:} EF14
        \qquad \textbf{Type d'exigence:} Exigence fonctionnelle
         \\
        \\
        \textbf{Cas d’utilisation:} Paramétrer l'approche de l'analyse de qualité  
        \\
        \\
        \textbf{Description :} le système doit fournir au Manager deux approches paramétrables d'analyse de la qualité, une approche basée sur des règles et une partie basée sur une analyse automatique utilisant les techniques NLP.
        \\
        \\
        \textbf{Acteur:} Manager
        \\
...
\\
\\
Ci-dessous, nous avons regroupé ces exigences à l'aide du diagramme de cas d'utilisation du langage UML,
\\
\\
\begin{figure}[h!]
